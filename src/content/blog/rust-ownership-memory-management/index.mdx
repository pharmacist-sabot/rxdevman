...
<InfoBox title="กฎของ Ownership" type="info">
...
<InfoBox title="Stack vs Heap: Copy vs Move" type="info">
...
<InfoBox title="Ownership คือ Contract" type="info">
...
- [The Rust Programming Language - The Stack and the Heap](https://doc.rust-lang.org/book/ch04-01-what-is-ownership.html#the-stack-and-the-heap)
